...
public class User {
  ...
  public void verifyElements(){
	  ...
	  AssertJUnit.assertEquals(true, elementUserLogin);
	  AssertJUnit.assertEquals(true, driver.findElement(By.linkText("create an account")).isDisplayed());
  ...
  public void login(){
	  ...
	  AssertJUnit.assertEquals(true, driver.findElement(By.id("tdb4")).isEnabled());
  }
